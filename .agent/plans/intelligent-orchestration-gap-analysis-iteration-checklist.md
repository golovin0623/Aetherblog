...
| 代码基线 | 本轮迭代后仓库 migrations 已至 **000068**；Agent Workflow 在 `000067_agent_workflow_run_simulated` 之后新增 `000068_agent_workflow_full_iteration`，补齐 runtime / governance / templates / approval / notification / marketplace 等产品边界 |
...
| 治理与数据边界 | P0-06, P0-14, P0-15, P0-16, P0-17, P1-01, P1-04, P1-05, P1-06, P1-07, P1-08, P1-10, P1-11, P1-16, P1-21 | `migrations/000068_agent_workflow_full_iteration.*.sql`、`agent_workflow_service.go`、`agent_workflow_repo.go` | tool/agent/schedule/variable CRUD；HTTP 工具 URL/方法治理；publication origin/rate/input schema；预算字段；审批暂停；生产脱敏；marketplace/error/human/cowork/notification 表边界 | `docker compose -f docker-compose.yml config --quiet`、`go test ./...` |
