...
Duration: 3-5 周。
- ATLAS-P2-04 KP embedding baseline · P2-05 selected/empty-scope atlas recall baseline · P2-11 D2 note_embeddings 策略闭环 · P1-07 全局搜索语义 rerank · G1-02 zoom/pan/minimap baseline · G1-03 inspector baseline · G1-04 filters baseline · G1-05 layout persistence baseline · G1-06 health metrics · P1-10 使用手册。
