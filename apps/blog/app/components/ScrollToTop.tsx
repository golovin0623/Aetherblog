...
const ScrollToTopBase = () => {
  ...
  return (
    <button
      type="button"
      onClick={scrollToTop}
      className={`surface-raised !rounded-full fixed bottom-8 right-8 z-50 p-2 transition-all duration-300 group hover:scale-110 active:scale-95 hidden md:block focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-primary)] focus-visible:outline-none ${
