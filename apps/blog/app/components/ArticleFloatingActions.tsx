...
// ⚡ Bolt: Extracted single TOC item into a memoized component.
// This ensures that when `activeId` changes during scrolling, only the
// previously active item and the newly active item re-render, reducing O(n) renders to O(1).
