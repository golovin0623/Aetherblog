    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between">
          ...
          {hasSkinOverride && (
            <button
              type="button"
              onClick={() => resetSkin()}
              className="inline-flex items-center gap-1 text-[11px] font-bold text-[var(--ink-muted)] transition-colors hover:text-[var(--ink-primary)] rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--aurora-1)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-raised)]"
            >
        ...
        <button
          ...
          className={cn(
            'mt-3 inline-flex h-10 w-full items-center justify-center gap-2 rounded-full text-xs font-black transition-transform hover:scale-[1.02] sm:h-9 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--aurora-1)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-raised)]',
            skinMode === 'custom'
