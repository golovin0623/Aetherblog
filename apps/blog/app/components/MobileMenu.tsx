      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 bottom-0 w-48 bg-[#0a0a0f] border-l border-white/10 z-[101] flex flex-col shadow-2xl will-change-transform overflow-y-auto"
          >
            {/* 1. 顶部区域：关闭按钮 + 个人资料 */}
            <div className="p-4 pb-4 border-b border-white/5 relative bg-gradient-to-b from-white/5 to-transparent">
              <button
                onClick={() => setIsOpen(false)}
            ...
            <div className="px-3 py-2 border-b border-white/5 flex justify-center">
              <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-[11px]">
                <a href="#" className="flex items-center gap-1.5 text-gray-400 hover:text-white transition-colors py-1">
