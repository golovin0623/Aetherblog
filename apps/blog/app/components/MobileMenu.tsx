      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 bottom-0 w-48 bg-white/30 dark:bg-black/40 backdrop-blur-2xl border-l border-white/10 dark:border-white/5 z-[101] flex flex-col shadow-2xl overflow-y-auto"
          >
            {/* 1. 顶部区域：个人资料 (去除了强分割线) */}
            <div className="p-6 pb-2 relative bg-gradient-to-b from-[var(--bg-card)]/50 to-transparent">
              <div className="mt-6 flex flex-col items-center text-center">
                ...
                <h3 className="text-black dark:text-[var(--text-primary)] font-bold text-sm mb-0.5">{authorBio}</h3>
              </div>
            </div>
            ...
            <div className="px-3 py-4 flex justify-center">
              <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-[11px]">
                <a href="#" className="flex items-center gap-1.5 text-black dark:text-[var(--text-muted)] hover:text-black dark:hover:text-[var(--text-primary)] transition-colors py-1">
