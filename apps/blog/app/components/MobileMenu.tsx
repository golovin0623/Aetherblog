          ...
          >
            ...
            <div className="p-4 space-y-2 mt-auto">
              ...
              {isAdminLinkAvailable ? (
                <a
                  href={adminHomeUrl!}
                  className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium text-black dark:text-[var(--text-secondary)] hover:text-black dark:hover:text-[var(--text-primary)] bg-black/5 dark:bg-white/5 border border-transparent dark:border-white/10 hover:bg-black/10 dark:hover:bg-white/10 transition-all shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-substrate)]"
                >
                  <Settings2 size={16} />
                  管理后台
                </a>
  ...
  return (
    <div className="md:hidden">
      ...
      <button
        ...
        className="p-2 text-[var(--text-muted)] hover:text-[var(--text-primary)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:rounded-lg focus-visible:ring-offset-2 focus-visible:ring-offset-transparent"
