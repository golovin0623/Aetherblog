      ...
      <div className="flex items-center justify-between mb-4">
        ...
        {variant !== 'sidebar' && (
          <button
            ...
            className="p-1 hover:bg-[var(--bg-card-hover)] rounded-md transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-substrate)]"
    ...
    <>
      ...
      {variant === 'icon' ? (
        <button
          ...
          className={`inline-flex items-center justify-center h-7 w-7 rounded-full border transition-all focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-substrate)] ${isDrawerOpen
        ...
        <button
          ...
          aria-expanded={isDrawerOpen}
          aria-controls="toc-drawer-content"
          className={`surface-raised fixed right-6 bottom-8 z-[55] flex items-center gap-2 px-5 py-3 text-sm font-medium text-[var(--ink-primary,var(--text-primary))] transition-all duration-500 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-transparent ${isReading ? 'translate-y-2 opacity-40 scale-95 blur-[0.5px]' : 'translate-y-0 opacity-100'
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button
                    ...
                    className="p-2 rounded-xl hover:bg-[var(--bg-card-hover)] text-[var(--text-muted)] hover:text-[var(--text-primary)] transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none focus-visible:rounded-xl focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-substrate)]"
                    aria-label="关闭目录导航"
                  >
                    <X className="h-5 w-5" />
                  </button>
...
const TocItemComponent = React.memo(function TocItemComponent({
  ...
  return (
    <button
      ...
      title={heading.text}
      className={`group relative block w-full text-left py-2 px-4 rounded-lg text-sm transition-all duration-200 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none focus-visible:rounded-lg focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-substrate)] ${isActive
