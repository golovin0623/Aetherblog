            ...
            <nav className="hidden md:flex gap-6 items-center">
              ...
              >
                ...
                <Link
                  ...
                  className={`relative z-10 w-[76px] text-center py-[7px] rounded-[11px] text-[13px] font-semibold tracking-[-0.01em] transition-all duration-200 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-secondary)] focus-visible:rounded-[11px] ${!isTimeline
