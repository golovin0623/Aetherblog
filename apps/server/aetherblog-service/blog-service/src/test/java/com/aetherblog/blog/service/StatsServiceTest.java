...
public class StatsServiceTest {
    ...
    void testGetRecentPostStats() {
        // Arrange
        when(postRepository.countByDeletedFalse()).thenReturn(100L);
        when(postRepository.countByDeletedFalseAndCreatedAtGreaterThanEqual(any(LocalDateTime.class))).thenReturn(5L, 20L);
