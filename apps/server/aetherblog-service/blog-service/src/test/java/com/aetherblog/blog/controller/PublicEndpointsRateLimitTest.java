...
public class PublicEndpointsRateLimitTest {
    ...
    @Test
    public void publicCommentControllerShouldHaveRateLimitAnnotation() throws NoSuchMethodException {
    ...
    @Test
    public void visitorControllerShouldHaveRateLimitAnnotation() throws NoSuchMethodException {
        ...
        assertEquals(60, rateLimit.count(), "Rate limit count mismatch");
        assertEquals(60, rateLimit.time(), "Rate limit time mismatch");
        assertEquals(RateLimit.LimitType.IP, rateLimit.limitType(), "Rate limit type mismatch");
    }
}
