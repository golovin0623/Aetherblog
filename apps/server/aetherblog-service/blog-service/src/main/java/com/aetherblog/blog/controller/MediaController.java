...
public class MediaController {
    ...
    @PostMapping("/upload")
    @RateLimit(key = "media:upload", count = 30, time = 60, limitType = RateLimit.LimitType.USER)
    ...
    @RateLimit(key = "media:upload:batch", count = 10, time = 60, limitType = RateLimit.LimitType.USER)
