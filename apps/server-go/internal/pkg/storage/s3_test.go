...
func TestS3Storage_DefaultEndpointsForCloudProviders(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			name:         "cos",
			providerType: "COS",
			cfg:          `{"bucket":"vanlog-1258312217","region":"ap-shanghai","accessKeyId":"k","secretAccessKey":"s"}`,
			wantEndpoint: "https://cos.ap-shanghai.myqcloud.com",
			wantURL:      "https://vanlog-1258312217.cos.ap-shanghai.myqcloud.com/2026/05/a.jpg",
		},
		{
			name:         "oss",
			providerType: "OSS",
...
func TestS3Storage_ImageHostCustomURLPathAndOptions(t *testing.T) {
	...
	objectKey, err := st.objectKey("02991ae95f727e56f72880e6aa30276c.image.png")
	if err != nil {
		t.Fatalf("objectKey: %v", err)
	}
	if objectKey != "img/02991ae95f727e56f72880e6aa30276c.image.png" {
		t.Fatalf("objectKey=%q", objectKey)
	}
	got := st.GetURL("02991ae95f727e56f72880e6aa30276c.image.png")
	want := "https://data.golovin.cn/img/02991ae95f727e56f72880e6aa30276c.image.png?imagevanblog"
	if got != want {
...
func TestS3Storage_PathPrefixIsTransparentForListingKeys(t *testing.T) {
	...
	if got := st.listPrefix("2026/05"); got != "img/2026/05" {
