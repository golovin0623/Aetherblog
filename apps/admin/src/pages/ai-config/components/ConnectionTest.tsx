    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-3">
        ...
        <select
          ...
          className="flex-1 rounded-xl border border-white/5 bg-[var(--bg-primary)]/50 px-3 py-2.5 text-sm text-[var(--text-primary)] focus:outline-none focus:border-primary/40 transition-all"
        >
          ...
          {chatModels.length > 0 ? (
            ...
            <option value="claude-haiku-4-5-20251001">claude-haiku-4-5-20251001 (默认)</option>
          )}
        </select>
