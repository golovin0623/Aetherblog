  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-[var(--text-muted)] mt-1">AI 自动分析内容并推荐合适的标签</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="space-y-3">
          <label className="text-sm font-medium text-[var(--text-tertiary)]">推荐标签</label>
          <div className="w-full h-80 px-4 py-3 rounded-xl bg-white/5 border border-white/10 overflow-auto">
            {isLoading ? (
              ...
              <span className="text-[var(--text-muted)]">推荐的标签将显示在这里</span>
            )}
          </div>
        </div>
      </div>
