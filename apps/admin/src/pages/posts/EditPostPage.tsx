        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-colors ${
              showSettings ? 'bg-primary text-white' : 'bg-white/10 text-gray-300'
            }`}
          >
            <Settings className="w-4 h-4" />
            设置
          </button>
          <button className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white/10 text-gray-300">
      ...
      <div className="flex-1 flex">
        <div className="flex-1 p-6 overflow-auto">
          <textarea
            ...
            className="w-full h-full bg-transparent text-white text-lg leading-relaxed focus:outline-none resize-none"
            placeholder="开始写作..."
          />
        </div>
        ...
        {showSettings && (
          <div className="w-80 border-l border-white/10 p-6 space-y-6 overflow-auto">
            ...
            <div>
              <label className="block text-sm text-gray-400 mb-2">封面</label>
              <div className="border-2 border-dashed border-white/20 rounded-lg p-6 text-center">
                <p className="text-gray-500">点击上传封面图</p>
              </div>
            </div>
