  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        'transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-substrate)]',
        variants[variant],
        sizes[size],
